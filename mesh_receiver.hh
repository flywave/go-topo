...
public:
  ...
  virtual void append_node(int face, double3 p, double3 n, double2 uv) = 0;

  virtual void append_node(int face, double3 p, double3 n) = 0;

  virtual void append_node(int face, double3 p) = 0;
