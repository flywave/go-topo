...
taxonomy::ptr mapping::map_impl(const IfcSchema::IfcIShapeProfileDef *inst) {
  ...
  // @todo in IFC4 a IfcAsymmetricIShapeProfileDef is not a subtype anymore of
  // IfcIShapeProfileDef!
  if (inst->declaration().is(
          IfcSchema::IfcAsymmetricIShapeProfileDef::Class())) {
    IfcSchema::IfcAsymmetricIShapeProfileDef *assym =
        (IfcSchema::IfcAsymmetricIShapeProfileDef *)inst;
