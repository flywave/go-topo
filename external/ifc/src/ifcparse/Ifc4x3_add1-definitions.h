...
#define SCHEMA_IfcGeographicCRS_HAS_GeodeticDatum
#define SCHEMA_IfcGeographicCRS_GeodeticDatum_IS_OPTIONAL
#define SCHEMA_IfcGeographicCRS_HAS_PrimeMeridian
#define SCHEMA_IfcGeographicCRS_PrimeMeridian_IS_OPTIONAL
#define SCHEMA_IfcGeographicCRS_HAS_Unit
#define SCHEMA_IfcGeographicCRS_Unit_IS_OPTIONAL
...
#define SCHEMA_IfcMapConversionScaled_HAS_ScaleX
#define SCHEMA_IfcMapConversionScaled_HAS_ScaleY
#define SCHEMA_IfcMapConversionScaled_HAS_ScaleZ
...
#define SCHEMA_IfcProjectedCRS_HAS_GeodeticDatum
#define SCHEMA_IfcProjectedCRS_GeodeticDatum_IS_OPTIONAL
