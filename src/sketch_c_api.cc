...
void sketch_clean(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); SAFE_CALL(sk, sk->ptr->clean()); }
...
void sketch_reset(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); SAFE_CALL(sk, sk->ptr->reset()); }
...
void sketch_solve(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); SAFE_CALL(sk, sk->ptr->solve()); }

sketch_t *sketch_copy(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); try {
...
void sketch_add(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); SAFE_CALL(sk, sk->ptr->add()); }

void sketch_subtract(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); SAFE_CALL(sk, sk->ptr->subtract()); }

void sketch_replace(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); SAFE_CALL(sk, sk->ptr->replace()); }
...
bool sketch_has_error(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); try { return sk->ptr->has_error();   }
  catch (const std::exception &e) {
    (void)e;
    return false;
  }
...
const char *sketch_error(sketch_t *sk) {
  std::lock_guard<std::recursive_mutex> ___cgo_glock(flywave::topo::topo_glock()); try { return sk->ptr->error().c_str();   }
  catch (const std::exception &e) {
    (void)e;
    return nullptr;
  }
